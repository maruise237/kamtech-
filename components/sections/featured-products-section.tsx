...
const features = [
  { image: "/images/4312e1bb-e030-4528-b6df-8a6ea69fe384.png", span: "col-span-2 row-span-2" },
  { image: "/images/b2401fa5-4eac-465f-b1f9-014aadc182ee.png", span: "col-span-1 row-span-1" },
  { image: "/images/dd1b32a8-3722-4ea2-8808-10d53532809d.png", span: "col-span-1 row-span-1" },
  { image: "/images/61af06cc-84d0-4031-a0ed-76fc43b1c1e1.png", span: "col-span-1 row-span-2" },
  { image: "/images/249083d2-c49c-4c06-a125-376284d90c42.png", span: "col-span-1 row-span-1" },
          ...
          {features.map((feature, index) => (
            ...
            >
              <FadeImage
                ...
                alt={`Solution KAMTECH IA ${index + 1}`}
                fill
